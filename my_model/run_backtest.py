...
# Import My Model
from my_model.model_development import precompute_features, compute_window_weights
...
def main():
    ...
    logging.info("Starting Bitcoin DCA Strategy Analysis - My Custom Model")
    
    # 1. Load Data
    btc_df = load_data()
    
    # 2. Precompute Features (using My Model logic)
    logging.info("Precomputing features (MVRV + MA200, no Polymarket)...")
    ...
    run_full_analysis(
        ...
        strategy_label="My Custom Model (EDA-based)",
    )
